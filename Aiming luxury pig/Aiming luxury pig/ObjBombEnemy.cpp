...
CObjBombEnemy::CObjBombEnemy(float x, float y)
{
	m_px = x;//位置
	m_py = y;
}
...
void CObjBombEnemy::Init()
{
	...
	//当たり判定用のHitBoxを作成
	Hits::SetHitBox(this, m_px, m_py, 30, 30, ELEMENT_ENEMY, OBJ_BOMBENEMY, 1);
}

//アクション
void CObjBombEnemy::Action()
{
	//落下
	if (m_py > 1000.0f)
	{
